...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        self.entity_list.extend(EntityFactory.get_entity(self.name + 'Bg'))  # Background entities
        player = EntityFactory.get_entity('Player1')
        player.score = player_score[0]
        self.entity_list.append(player)  # Set player score for Player1
